...
function cmsmasters_owl_slider_run(data) {
	var data_id = data['data_id'],
		...
		data_navigationPrev = '<span class="cmsmasters_prev_arrow"><i class="fas fa-arrow-left"></i></span>',
		data_navigationNext = '<span class="cmsmasters_next_arrow"><i class="fas fa-arrow-right"></i></span>',
		params = {};
